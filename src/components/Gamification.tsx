...
export default function Gamification() {
  ...
  const currentLevel = getUserLevel(settings.totalPoints);
  const pointsToNextLevel = getPointsToNextLevel(settings.totalPoints);
  const progressPercentage = currentLevel.level < 10 
    ? ((settings.totalPoints - currentLevel.pointsRequired) / 
